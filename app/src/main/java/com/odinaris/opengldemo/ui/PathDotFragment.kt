...
import com.odinaris.opengldemo.widget.PathDotGLView


class PathDotFragment : Fragment() {

    private lateinit var binding: FragmentPathDotBinding
    private lateinit var mGLView: PathDotGLView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        mGLView = PathDotGLView(requireContext())
        binding.root.addView(mGLView)
    }

    companion object {
        const val TAG = "PathDotFragment"
    }
